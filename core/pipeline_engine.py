...
class PipelineEngine:
    ...
    def run(self, initial_params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        # 绑定可复现性指纹（引擎版本/seed/容差），供 AEN 证据审计
        from .provenance import snapshot_provenance, jsonable
        self.metadata["provenance"] = snapshot_provenance(extra={
            "pipeline": self.name,
            "params": jsonable(initial_params or {}),
        })
