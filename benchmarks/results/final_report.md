...
**Tiers**: Raw LLM (no tools) | Raw MCP (LLM picks tools) | Harness MCP (ToolRouter)

---

## Executive Summary / 总览

| Model | Raw LLM | Raw MCP | Harness MCP | Engine |
|-------|---------|---------|-------------|--------|
| qwen3-8b | 0% | 42% | **100%** | 100% |
| qwen3-32b | 0% | 41% | **100%** | 100% |
| DeepSeek-V3.2 | 80% | 81% | **100%** | 100% |

**Bottleneck**: Tool selection, not math computation. Harness ToolRouter eliminates the 59pp gap.
...
| Model | Raw LLM Score | Raw MCP Score | Raw MCP Verified | Harness | Analysis |
|-------|--------------|---------------|-----------------|---------|----------|
| qwen3-8b | 0% | 100% | Yes | **100%** | MAF tools enabled correct answer |
| qwen3-32b | 0% | 70% | Yes | **100%** | MAF tools enabled correct answer |
...
| Model | Raw LLM Score | Raw MCP Score | Raw MCP Verified | Harness | Analysis |
|-------|--------------|---------------|-----------------|---------|----------|
| qwen3-8b | 0% | 70% | Yes | **100%** | MAF tools enabled correct answer |
| qwen3-32b | 0% | 70% | Yes | **100%** | MAF tools enabled correct answer |
| DeepSeek-V3.2 | 100% | 100% | Yes | **100%** | Both correct |
...
| qwen3-8b | 0% | 70% | Yes | **100%** | MAF tools enabled correct answer |
| qwen3-32b | 0% | 70% | Yes | **100%** | MAF tools enabled correct answer |
| DeepSeek-V3.2 | 0% | 70% | Yes | **100%** | MAF tools enabled correct answer |
...
| Model | Raw LLM Score | Raw MCP Score | Raw MCP Verified | Harness | Analysis |
|-------|--------------|---------------|-----------------|---------|----------|
| qwen3-8b | 0% | 0% | No | **100%** | Both failed (computed: 1) |
| qwen3-32b | 0% | 0% | No | **100%** | Both failed (computed: 1) |
...
|-------|--------------|---------------|-----------------|---------|----------|
| qwen3-8b | 0% | 70% | Yes | **100%** | MAF tools enabled correct answer |
| qwen3-32b | 0% | 100% | Yes | **100%** | MAF tools enabled correct answer |
| DeepSeek-V3.2 | 100% | 100% | Yes | **100%** | Both correct |
...
| Model | Raw LLM Score | Raw MCP Score | Raw MCP Verified | Harness | Analysis |
|-------|--------------|---------------|-----------------|---------|----------|
| qwen3-8b | 0% | 0% | No | **100%** | Both failed (computed: Eq(f(x), (C1*sin(sqrt(3)*x/2) ) |
| qwen3-32b | 0% | 0% | No | **100%** | Both failed (computed: Eq(f(x), (C1*sin(sqrt(3)*x/2) ) |
| DeepSeek-V3.2 | 100% | 100% | No | **100%** | Both correct |
...
| Model | Raw LLM Score | Raw MCP Score | Raw MCP Verified | Harness | Analysis |
|-------|--------------|---------------|-----------------|---------|----------|
| qwen3-8b | 0% | 0% | No | **100%** | Both failed (computed: Requires further analysis) |
| qwen3-32b | 0% | 0% | No | **100%** | Both failed (computed: Requires further analysis) |
| DeepSeek-V3.2 | 0% | 0% | No | **100%** | Both failed (computed: Requires further analysis) |
...
| qwen3-8b | 0% | 0% | No | **100%** | Both failed (computed: Requires further analysis) |
| qwen3-32b | 0% | 0% | No | **100%** | Both failed (computed: Requires further analysis) |
| DeepSeek-V3.2 | 100% | 0% | No | **100%** | LLM got it right but MAF verification failed (computed: Requires further analysis) |
